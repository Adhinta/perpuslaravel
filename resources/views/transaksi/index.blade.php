...
<div class="row">
  ...
  <div class="col-lg-2">
    <a href="{{ route('transaksi.create') }}" class="btn btn-primary btn-rounded btn-fw">
                      ...
                      @foreach($datas as $data)
                        <tr>
                          ...
                          @if($data->status == 'pinjam')
                            <?php 
                              $today = date_create();
                              // $targetBack = date('d/m/Y', strtotime($data->tgl_kembali));
                              $targetBack = date_create($data->tgl_kembali);
                              
                                if($today > $targetBack){
                                  ?>
                                  <label class="badge badge-danger">Pinjam</label>
                                  <?php
                                } else {
                                ?>
