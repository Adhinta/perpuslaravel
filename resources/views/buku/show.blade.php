                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <div class="form-group{{ $errors->has('no_inventaris') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="no_inventaris" type="number" class="form-control" name="no_inventaris" value="{{  $data->no_inventaris }}" readonly>
                        ...
                        <div class="form-group{{ $errors->has('tempat_tahun_terbit') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="tempat_tahun_terbit" type="text" class="form-control" name="tempat_tahun_terbit" value="{{ $data->tempat_tahun_terbit }}" readonly>
                        ...
                        <div class="form-group{{ $errors->has('cetakan_jilid') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="cetakan_jilid" type="text" class="form-control" name="cetakan_jilid" value="{{  $data->cetakan_jilid }}" readonly>
                        ...
                        <div class="form-group{{ $errors->has('asal') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="asal" type="text" class="form-control" name="asal" value="{{ $data->asal }}" readonly>
                                @if ($errors->has('asal'))
                                    <span class="help-block">
                        ...
                        <div class="form-group{{ $errors->has('harga') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="harga" type="text" class="form-control" name="harga" value="{{ $data->harga }}" readonly>
                                @if ($errors->has('harga'))
                                    <span class="help-block">
                        ...
                        <div class="form-group{{ $errors->has('ukuran') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="ukuran" type="text" class="form-control" name="ukuran" value="{{ $data->ukuran }}" readonly>
                        ...
                        <div class="form-group{{ $errors->has('jumlah_buku') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="jumlah_buku" type="number" class="form-control" name="jumlah_buku" value="{{  $data->jumlah_buku }}" readonly>
